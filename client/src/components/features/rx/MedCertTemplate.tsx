    ...
    return (
      <div ref={ref}>
        ...
        <div className="absolute top-0 left-0 h-0 w-0 overflow-hidden opacity-0 pointer-events-none" aria-hidden="true">
            <span style={{ fontFamily: "'Glacial', sans-serif", fontWeight: 400 }}>.</span>
            <span style={{ fontFamily: "'Glacial', sans-serif", fontWeight: 700 }}>.</span>
        ...
        >
          ...
          {/* --- CONTENT WRAPPER --- */}
          <div className="relative z-10 flex flex-col" style={{ padding: "15mm 20mm", paddingBottom: "70mm", height: "100%" }}>
            
            {/* 1. HEADER */}
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20mm' }}>
              ...
              <div style={{ flexGrow: 1, textAlign: 'right' }}>
                <h1 style={{ fontFamily: "'Lobster', cursive", fontSize: '24pt', color: BRAND_COLOR, lineHeight: 1, margin: 0 }}>
                  {doctor.name}, {doctor.title}
                </h1>
                <p style={{ fontFamily: "'Glacial', sans-serif", fontWeight: '700', fontSize: '10pt', color: ACCENT_COLOR, textTransform: 'uppercase', margin: '4px 0 0 0', letterSpacing: '1px' }}>
                  {doctor.specialty}
                </p>
                <p style={{ fontSize: '9pt', color: ACCENT_COLOR, margin: '2px 0 0 0' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '15mm' }}>
               <h2 style={{ fontSize: '22pt', fontWeight: '700', color: BRAND_COLOR, letterSpacing: '3px', margin: 0, textTransform: 'uppercase' }}>
                 Medical Certificate
               </h2>
            </div>
            ...
            <div style={{ fontSize: '12pt', lineHeight: '1.8' }}>
               ...
               <p style={{ textAlign: 'justify' }}>
                 This is to certify that <RenderField value={data.patientName} minWidth="200px" isBold={true} />, 
                 <RenderField value={data.age} minWidth="40px" /> years old, <RenderField value={data.sex} minWidth="60px" />, 
                 presently residing at <RenderField value={data.address} minWidth="250px" />, 
                 was examined / treated in this clinic on {renderDate(data.date)} for <RenderField value={data.reason} minWidth="150px" />.
               </p>

               {/* Clinical Findings */}
               <div style={{ marginTop: '10mm', display: 'flex', flexDirection: 'column', gap: '8mm' }}>
                  <div style={{ backgroundColor: '#f8fafc', padding: '5mm', borderRadius: '4px', borderLeft: `4px solid ${BRAND_COLOR}` }}>
                     <p style={{ fontWeight: '700', color: BRAND_COLOR, fontSize: '10pt', textTransform: 'uppercase', marginBottom: '2mm', letterSpacing: '0.5px' }}>
                       Assessment / Diagnosis
                     </p>
                     <p style={{ whiteSpace: 'pre-wrap', color: '#334155', lineHeight: '1.5' }}>
               ...
               <p style={{ marginTop: '10mm', fontStyle: 'italic', fontSize: '10pt', color: ACCENT_COLOR }}>
                 This certificate is issued upon the patient's request for whatever legal purpose it may serve, except for medicolegal matters.
               </p>
            </div>
          ...
          >
              <div style={{ height: '25mm', display: 'flex', alignItems: 'flex-end', justifyContent: 'center', marginBottom: '2mm' }}>
                 {doctor.signatureUrl && (
                   <img src={doctor.signatureUrl} alt="Signature" style={{ maxHeight: '100%', maxWidth: '100%', mixBlendMode: 'multiply' }} />
                 )}
              </div>
              <div style={{ borderBottom: `1px solid ${ACCENT_COLOR}`, marginBottom: '1mm' }}></div>
              <p style={{ fontWeight: '700', fontSize: '11pt', color: BRAND_COLOR, textTransform: 'uppercase' }}>
                 {doctor.name}, {doctor.title}
              </p>
              <div style={{ fontSize: '9pt', color: ACCENT_COLOR, marginTop: '1mm' }}>
                 <span style={{ display: 'block' }}>Lic No. {doctor.licenseNo}</span>
